...
numbers_list = []
while True:
    inp_number = input("Введите число (для остановки наберите stop): ")
    try:
        if inp_number.isnumeric() == 0:
            raise OwnError("Вы ввели не число!")
        numbers_list.append(float(inp_number))
...
print(f'Итоговый список чисел: {numbers_list}')
